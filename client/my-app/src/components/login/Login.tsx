    ...
    return (
        <div className={styles.container}>
            <form onSubmit={handleSubmit(onSubmit)}>
                <input className={styles.inputs} {...register('email', {required: "Укажите email!",
                    pattern: {
                ...
                <input className={styles.inputs} {...register('password', {required: 'Введите пароль!', minLength: 5})} placeholder={'пароль'}/>
